...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Начальная страница","1. Регистрация","2. Поиск тура","3. Фильтр туров","4. Сортировка","5. Покупка тура","6. Аккаунт ","7. Отчеты","8. Выход из приложения","1.1. Вход в приложение","1.2. Вход в систему как админ","6.1. Редактирование аккаунта","7.1. Report 1","7.2. Report 2"],
    DREX_NODE_LINKS: ["index.htm","registratsiya.htm","poisk_tura.htm","filtr_turov.htm","sortirovka.htm","pokupka_tura.htm","akkaunt_.htm","otchety.htm","vykhod_iz_prilozheniya.htm","vkhod_v_prilozhenie.htm","vkhod_v_sistemu_kak_admin.htm","redaktirovanie_akkaunta.htm","report_1.htm","report_2.htm"],
    DREX_NODE_CHILD_START: [1,9,11,11,11,11,11,12,14,14,14,14,14,14],
    DREX_NODE_CHILD_END: [9,11,11,11,11,11,12,14,14,14,14,14,14,14],
    DREX_MENU_TYPE: 2,
